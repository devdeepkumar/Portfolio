$(document).ready(function () {
    ...
    $("#contact-form").submit(function (event) {
        emailjs.init("peFsBGSCOfH-NnKSg");

        emailjs
          .sendForm("service_tx9h1et", "template_va8kgoq", "#contact-form")
          .then(
            function (response) {
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Devdeep Kumar";
            $("#favicon").attr("href", "assets/images/favicon.png");
        }
        else {
            document.title = "Come Back To Devdeep Portfolio";
